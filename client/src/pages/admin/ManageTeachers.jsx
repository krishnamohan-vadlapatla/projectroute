...
import { BadgeCheck, Plus, Users, X, TriangleAlert, AlertTriangle } from "lucide-react";
const ManageTeachers = () => {
  ...
  const handleEdit = (teacher) => {
    ...
    setFormData({
      ...
      experties: Array.isArray(teacher.expertise)
        ? teacher.expertise[0]
        : teacher.expertise,
      maxStudents:
                      ...
                      <tr key={teacher._id} className="hover:bg-slate-50">
                        <td className="px-6 py-4">
                          <div>
                            ...
                            <div className="text-sm teslt-slate-500">
                              {teacher.email}
                            </div>
                          </div>
                        </td>
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                  <div>
                    ...
                    <input
                      ...
                      className="input w-full py-1 border-b border-slate-600 focus:outline-none"
                    />
                  </div>
                  <div>
                    <label className="block text-sm font-medium text-slate-700 mb-1">
