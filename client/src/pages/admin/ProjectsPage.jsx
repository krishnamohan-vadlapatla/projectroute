...
const ProjectsPage = () => {
  ...
  {project.supervisor?.name ? (
    <span className="inline-flex items-center px-2.5 py-0.5 rounded-full bg-green-100 text-green-800 text-sm font-medium">
      {project.supervisor.name}
    </span>
  ) : (
    <span className="inline-flex items-center px-2.5 py-0.5 rounded-full bg-gray-100 text-gray-600 text-sm font-medium">
      Unassigned
    </span>
  )}
</td>
                  ...
                  {filteredFiles.map((f) => {
                    return (
                      ...
                      >
                        ...
                        <button  className="btn-outline btn-small" onClick={() => handleDownloadFile(f)}>
                          Download
                        </button>
                      </div>
                    );
