...
const StudentDashboard = () => {
  ...
  <div className="relative overflow-hidden rounded-lg bg-gradient-to-br from-purple-700 via-indigo-900 to-purple-900 p-8 text-white shadow-xl ring-1 ring-white/10">
  ...
  <div className="card">
    ...
    <div className="flex items-center">
      ...
      <div className="ml-4">
        ...
        <p className="text-lg font-semibold text-slate-800">{feedbackList?.length?formatDate(feedbackList[0]?.createdAt):"N/A"}</p>
      </div>
...
<div className="card">
  <div className="card-header flex items-center justify-between">
    <h2 className="card-title">Latest Feedback</h2>
        <Link to={"/student/feedback"} className="text-sm bg-blue-500 text-white px-3 py-1 rounded-full font-medium hover:bg-blue-600 transition-all duration-300">View All</Link>
...

{
  ...
  <div className="card">
    <div className="card-header">
      ...
      {
        topNotifications && topNotifications.length>0?(<div className="space-y-3">
          {
